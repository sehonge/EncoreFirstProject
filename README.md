...
| ---- | ---------------- | ------------------ | ------------------------------------------------------------ | -------- | ------ |
| 1    | 메인화면         | 상단 배너 구성     | Home, 메뉴, Mypage 3개로 구성한다.  |          | 오형석 |
| MI-02    | 메인   | 화면 개설      | [인트로] 화면을 구성한다.  -예시 : https://www.mrpizza.co.kr/ |        | 오형석       |
| 2    | 로그인           | 로그인 화면 구현   | 화면 구성, 퀵 메뉴 2가지로 구성한다. ID, PW를 입력 받는다. |          | 오형석 |
| 2    | 로그아웃           | 로그아웃 화면 구현   | 화면 구성 없이, 퀵 메뉴로 만든다. |          | 오형석 |
| 3    | 회원가입         | 회원가입 화면 구성 | 화면 구성 후, 회원 정보 입력 받아 회원등록 한다. |          | 오형석 |
| 4    | 개인정보수정     | 개인정보 수정 구성 | 마이페이지에 회원 정보 수정 사이드메뉴로 구성한다.  |          | 오형석 |
| 5    |                  |                    |                                                              |          |        |
| 6    |                  |                    |                                                              |          |        |
| 7    |                  |                    |                                                              |          |        |
| 8    |                  |                    |                                                              |          |        |
